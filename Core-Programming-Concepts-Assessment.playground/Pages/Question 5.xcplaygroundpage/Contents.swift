...
if newSnowfallAmount >= 10,temperatureInCelsius >= -5, if isSnowMakingEquipmentBroken = false
print (" we're open!")
if newSnowfallAmount <= 10, temperatureInCelsius <= -5, if isSnowMakingEquipmentBroken = true
print (" we're closed.")
