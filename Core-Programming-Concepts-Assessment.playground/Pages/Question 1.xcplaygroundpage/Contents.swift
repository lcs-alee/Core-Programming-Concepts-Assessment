...
let temperatureFahrenheit = temperaturecelsisus * 9 / 5 + 32
print("A temperature in degrees Celsius of \(temperaturecelsisus) is equal to \(temperatureFahrenheit) in degrees Fahrenheit.")
